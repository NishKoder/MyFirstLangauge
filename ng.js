...
var grammar = {
    ...
    {"name": "while_loop", "symbols": ["while_loop$string$1", "_", "binary_expression", "_", {"literal":"["}, "_", {"literal":"\n"}, "statements", {"literal":"\n"}, {"literal":"]"}], "postprocess": 
        data => {
            return {
                type: "while_loop",
                condition: data[2],
    ...
    {"name": "operator", "symbols": [{"literal":"-"}], "postprocess": id},
    {"name": "operator", "symbols": [{"literal":"x"}], "postprocess": id},
    {"name": "operator", "symbols": [{"literal":"/"}], "postprocess": id},
    {"name": "operator", "symbols": [{"literal":">"}], "postprocess": id},
    {"name": "operator", "symbols": [{"literal":"<"}], "postprocess": id},
    ...
    {"name": "number", "symbols": ["digit", {"literal":"."}, "digit"], "postprocess": 
        data => Number(data[0] + "." + data[2])
                },
    {"name": "number", "symbols": ["digit"], "postprocess": data => Number(data[0])},
    ...
    {"name": "_", "symbols": ["_$ebnf$2"], "postprocess": function(d) {return null; }}
]
  , ParserStart: "program"
}
